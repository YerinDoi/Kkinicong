  ...
  return (
    <>
      <button
        ...
        className="flex items-center shrink-0 py-1 px-3 rounded-[12px] border border-main-gray bg-bg-gray whitespace-nowrap text-[16px] font-medium leading-[24px] mb-[4px]"
      >
        <img
          src={settingIcon}
          alt="카테고리 설정 아이콘"
