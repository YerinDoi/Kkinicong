...
interface ScrapStoreListSectionProps {
  ...
  isFixedSheet: boolean;
}

const ScrapStoreListSection = forwardRef(
  (
    {
      scrapStores,
      setSheetHeight,
    ...
    const {
      ...
      setSheetHeight: setLocalSheetHeight,
      raisedSheetHeight,
      handleTouchStart,
      handleTouchMove,
      handleTouchEnd,
    ...
    // resetToMaxHeight 메서드 노출
    useImperativeHandle(
      ref,
      () => ({
        resetToMaxHeight: () => setLocalSheetHeight(raisedSheetHeight),
      }),
      [raisedSheetHeight],
    );
    ...
    return (
      <div
        ...
        style={{
          height: isFixedSheet ? 167 : localSheetHeight,
