...
const PostItem = ({ post }: { post: Post }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className="flex flex-col cursor-pointer px-[20px] gap-[12px] py-[12px] border-b border-[#C3C3C3]"
    >
      <div
        className={`flex ${hasThumbnail ? 'flex-row justify-between ' : 'flex-col gap-[12px]'} `}
      >
