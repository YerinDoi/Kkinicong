...
const CommentBox: React.FC<CommentBoxProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex flex-col gap-[12px] font-pretendard">
      <div className="flex text-main-gray justify-between ">
      ...
      <textarea
        ...
        className="placeholder-main-gray text-text-gray text-body-md-description px-[16px] pt-[12px] pb-[40px] flex border border-sub-gray rounded-[12px]"
      ></textarea>
    </div>
  );
};
